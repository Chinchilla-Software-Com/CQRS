...
<profile dslVersion="1.0.0.0" name="CqrsProfile" displayName="Cqrs Profile" xmlns="http://schemas.microsoft.com/UML2.1.2/ProfileDefinition">
  <stereotypes>
    ...
    <stereotype name="AutoGenerated" displayName="AutoGenerated: This object is automatically generated into the UML based on some other enabled or disabled feature, but not directly generated by the T4 templates. Any changes made to a class with this stereo-type added may be over-written and are read during code generation." >
      <metaclasses>
        <metaclassMoniker name="/CqrsProfile/Microsoft.VisualStudio.Uml.Classes.IClass" />
