...
namespace $safeprojectname$.Areas.HelpPage
{
	...
	public static class HelpPageConfig
	{
		...
		[SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "$safeprojectname$.Areas.HelpPage.TextSample.#ctor(System.String)", Justification = "End users may choose to merge this string with existing localized resources.")]
