...
using System.Linq;
using $ext_safeprojectname$.MicroServices.Authentication.Entities;
using $ext_safeprojectname$.MicroServices.Authentication.Helpers;
using $ext_safeprojectname$.MicroServices.Authentication.Repositories;
using $ext_safeprojectname$.MicroServices.Configuration;
using $ext_safeprojectname$.MicroServices.Conversations;
using $ext_safeprojectname$.MicroServices.Conversations.Commands;
using $ext_safeprojectname$.MicroServices.Conversations.Events;
using $ext_safeprojectname$.MicroServices.Conversations.Repositories;
