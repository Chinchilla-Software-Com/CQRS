...
using System.Linq;
using $safeprojectname$.MicroServices.Authentication.Entities;
using $safeprojectname$.MicroServices.Authentication.Helpers;
using $safeprojectname$.MicroServices.Authentication.Repositories;
using $safeprojectname$.MicroServices.Configuration;
using $safeprojectname$.MicroServices.Conversations;
using $safeprojectname$.MicroServices.Conversations.Commands;
using $safeprojectname$.MicroServices.Conversations.Events;
using $safeprojectname$.MicroServices.Conversations.Repositories;
