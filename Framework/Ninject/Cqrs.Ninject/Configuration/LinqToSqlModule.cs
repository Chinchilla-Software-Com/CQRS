...
{
	/// <summary>
	/// The <see cref="INinjectModule"/> to wireup <see cref="IEvent{TAuthenticationToken}"/> to <see cref="LinqToSqlEventStore{TAuthenticationToken}"/>.
	/// </summary>
...
#region Overrides of NinjectModule
		...
		public virtual void RegisterEventStore()
		{
			Bind<IEventStore<TAuthenticationToken>>()
				.To<LinqToSqlEventStore<TAuthenticationToken>>()
				.InSingletonScope();
			Bind<ISnapshotStore>()
				.To<LinqToSqlSnapshotStore>()
				.InSingletonScope();
		}
	}
}
