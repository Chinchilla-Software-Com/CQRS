...
namespace Cqrs.Azure.ServiceBus
{
		...
		: AzureEventHub<TAuthenticationToken>
	{
		...
		{
			get { return "Cqrs.Azure.EventHub.EventBus.Connection.Endpoint"; }
		}
		...
		{
			get { return "Cqrs.Azure.EventHub.EventBus.Connection.ApplicationId"; }
		}
		...
		{
			get { return "Cqrs.Azure.EventHub.EventBus.Connection.ClientKey"; }
		}
		...
		{
			get { return "Cqrs.Azure.EventHub.EventBus.Connection.TenantId"; }
		}
