...
namespace Cqrs.Azure.Storage.Test.Integration
{
	...
	public class TableStorageEventStoreTests
	{
				...
				Save_ValidEvent_EventCanBeRetreived()
		{
			...
			var eventStore = CreateEventStore(new DefaultEventBuilder<Guid>(), new EventDeserialiser<Guid>(), logger, new TableStorageEventStoreConnectionStringFactory(configurationManager, logger));
