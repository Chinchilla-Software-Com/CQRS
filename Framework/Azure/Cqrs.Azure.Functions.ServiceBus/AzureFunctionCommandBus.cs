...
namespace Cqrs.Azure.Functions.ServiceBus
{
	...
	public abstract class AzureFunctionCommandBus<TAuthenticationToken>
		: AzureFunctionServiceBus<TAuthenticationToken>
	{
		#region Overrides of AzureFunctionServiceBus<TAuthenticationToken>
		...
		/// <summary>
		/// Instantiate a new instance of <see cref="AzureFunctionCommandBus{TAuthenticationToken}"/>.
		/// </summary>
		protected AzureFunctionCommandBus(IConfigurationManager configurationManager, IMessageSerialiser<TAuthenticationToken> messageSerialiser, IAuthenticationTokenHelper<TAuthenticationToken> authenticationTokenHelper, ICorrelationIdHelper correlationIdHelper, ILogger logger, IAzureBusHelper<TAuthenticationToken> azureBusHelper, IBusHelper busHelper, IHashAlgorithmFactory hashAlgorithmFactory, bool isAPublisher)
