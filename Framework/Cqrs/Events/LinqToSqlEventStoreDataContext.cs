...
namespace Cqrs.Events
{
	...
	/// </summary>
	public class LinqToSqlEventStoreDataContext : DataContext
	{
		/// <summary>
		/// Instantiates a new instance of the <see cref="LinqToSqlEventStoreDataContext"/> class by referencing a file source.
		/// </summary>
		...
		/// </param>
		public LinqToSqlEventStoreDataContext(string fileOrServerOrConnection)
			: base(fileOrServerOrConnection) { }

		/// <summary>
		/// Instantiates a new instance of the <see cref="LinqToSqlEventStoreDataContext"/> class by referencing a connection.
		/// </summary>
		/// <param name="connection">The connection used by the .NET Framework.</param>
		public LinqToSqlEventStoreDataContext(System.Data.IDbConnection connection)
			: base(connection) { }

		private LinqToSqlEventStoreDataContext(CustomMappingSource sharedMappingSource, System.Data.IDbConnection connection)
			: base(connection, sharedMappingSource) { }

		private LinqToSqlEventStoreDataContext(CustomMappingSource sharedMappingSource, string fileOrServerOrConnection)
		...
		/// A complete connection string. LINQ to SQL just passes the string to the provider without modification.
		/// </param>
		public static LinqToSqlEventStoreDataContext New<TTable>(string tableName, string fileOrServerOrConnection)
		{
		...
		/// <param name="tableName">The name of the table.</param>
		/// <param name="connection">The connection used by the .NET Framework.</param>
		public static LinqToSqlEventStoreDataContext New<TTable>(string tableName, System.Data.IDbConnection connection)
		{
		...
		/// A complete connection string. LINQ to SQL just passes the string to the provider without modification.
		/// </param>
		public static LinqToSqlEventStoreDataContext New(Type rowType, string tableName, string fileOrServerOrConnection)
		{
			return new LinqToSqlEventStoreDataContext(New(rowType, tableName), fileOrServerOrConnection);
		}
		...
		/// <param name="tableName">The name of the table.</param>
		/// <param name="connection">The connection used by the .NET Framework.</param>
		public static LinqToSqlEventStoreDataContext New(Type rowType, string tableName, System.Data.IDbConnection connection)
		{
			return new LinqToSqlEventStoreDataContext(New(rowType, tableName), connection);
		}
	}
