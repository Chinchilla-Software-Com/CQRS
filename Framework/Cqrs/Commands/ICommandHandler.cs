...
namespace Cqrs.Commands
{
	...
	/// The <see cref="IUnitOfWork{TAuthenticationToken}"/> should then have uncommited <see cref="IEvent{TAuthenticationToken}"/> artefacts as a results of asking the <see cref="IAggregateRoot{TAuthenticationToken}"/> to handle the <see cref="ICommand{TAuthenticationToken}"/>.
	/// Finally the <see cref="ICommandHandler{TAuthenticationToken,TCommand}"/> should instruct the <see cref="IUnitOfWork{TAuthenticationToken}"/> to <see cref="IUnitOfWork{TAuthenticationToken}.Commit"/> all uncommited <see cref="IEvent{TAuthenticationToken}"/> artefacts.
	/// 
	...
	/// 
	/// 
	/// Can I call a read side (such as a read store, data store or <see cref="IRepository{TAuthenticationToken}"/>) from my <see cref="ICommandHandler{TAuthenticationToken,TCommand}"/>?
	/// 
	/// No.
	/// 
	/// 
