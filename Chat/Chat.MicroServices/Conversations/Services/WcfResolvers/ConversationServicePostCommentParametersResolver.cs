namespace Chat.MicroServices.Conversations.Services.WcfResolvers
{
	...
	public class ConversationServicePostCommentParametersResolver : BasicServiceParameterResolver<IConversationService, Guid>
	{
		...
		{
			WcfDataContractResolverConfiguration.Current.RegisterDataContract<IConversationService, ConversationServicePostCommentParametersResolver>("PostCommentParameters");
		}
	}
}