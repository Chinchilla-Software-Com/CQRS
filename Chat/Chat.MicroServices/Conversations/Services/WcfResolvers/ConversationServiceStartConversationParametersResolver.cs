namespace Chat.MicroServices.Conversations.Services.WcfResolvers
{
	...
	public class ConversationServiceStartConversationParametersResolver : BasicServiceParameterResolver<IConversationService, Guid>
	{
		...
		{
			WcfDataContractResolverConfiguration.Current.RegisterDataContract<IConversationService, ConversationServiceStartConversationParametersResolver>("StartConversationParameters");
		}
	}
}