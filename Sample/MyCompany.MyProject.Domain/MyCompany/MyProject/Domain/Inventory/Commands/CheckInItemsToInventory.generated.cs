...
namespace MyCompany.MyProject.Domain.Inventory.Commands
{
	...
	public  partial class CheckInItemsToInventoryCommand : ICommand<Cqrs.Authentication.ISingleSignOnToken>
	{
		...
		public CheckInItemsToInventoryCommand(Guid rsn, long count)
		{
			Rsn = rsn;
			Count = count;
		}
