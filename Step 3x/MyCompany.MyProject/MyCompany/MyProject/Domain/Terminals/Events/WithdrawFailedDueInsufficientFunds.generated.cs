...
namespace MyCompany.MyProject.Domain.Terminals.Events
{
	...
	public  partial class WithdrawFailedDueInsufficientFunds : IEvent<Cqrs.Authentication.ISingleSignOnToken>
	{
		...
		public WithdrawFailedDueInsufficientFunds(Guid rsn, double amount)
		{
			Rsn = rsn;
			Amount = amount;
		}
