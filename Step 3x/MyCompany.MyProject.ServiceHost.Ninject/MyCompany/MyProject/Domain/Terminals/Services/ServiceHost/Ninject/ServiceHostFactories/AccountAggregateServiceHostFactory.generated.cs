...
{
	/// <summary>
	/// A <see cref="NinjectWcfServiceHostFactory{TServiceType}"/> for using  <see cref="IAccountService"/> via WCF
	/// </summary>
	[GeneratedCode("CQRS UML Code Generator", "1.601.786")]
	public partial class AccountServiceHostFactory : NinjectWcfServiceHostFactory<IAccountService>
	{
	}
