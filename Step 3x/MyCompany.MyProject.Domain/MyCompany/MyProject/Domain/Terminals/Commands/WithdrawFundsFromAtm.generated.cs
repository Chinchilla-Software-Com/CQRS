...
namespace MyCompany.MyProject.Domain.Terminals.Commands
{
	...
	public  partial class WithdrawFundsFromAtmCommand : ICommand<Cqrs.Authentication.ISingleSignOnToken>
	{
		...
		public WithdrawFundsFromAtmCommand(Guid rsn, double amount)
		{
			Rsn = rsn;
			Amount = amount;
		}
