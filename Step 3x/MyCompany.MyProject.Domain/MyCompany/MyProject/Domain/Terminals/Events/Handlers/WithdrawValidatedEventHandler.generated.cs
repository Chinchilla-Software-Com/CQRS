...
namespace MyCompany.MyProject.Domain.Terminals.Events.Handlers
{
	...
	public  partial class WithdrawValidatedEventHandler
		...
		: IEventHandler<Cqrs.Authentication.ISingleSignOnToken, WithdrawValidated>
	{

		#region Implementation of IEventHandler<in WithdrawValidated>

		public void Handle(WithdrawValidated @event)
		{
			OnHandle(@event);
		}
