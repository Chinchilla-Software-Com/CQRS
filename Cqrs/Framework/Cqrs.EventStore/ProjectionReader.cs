...
{
	public abstract class ProjectionReader<TPermissionToken>
	{
		...
		protected ProjectionReader(IEventStoreConnectionHelper eventStoreConnectionHelper, IEventDeserialiser<TPermissionToken> eventDeserialiser)
		{
