...
namespace MyCompany.MyProject.Domain.Inventory.Events
{
	...
	public  partial class RemoveItemsFromInventoryFailedDueNegativeCount : IEvent<Cqrs.Authentication.ISingleSignOnToken>
	{
		...
		public RemoveItemsFromInventoryFailedDueNegativeCount(Guid rsn, long count)
		{
			Rsn = rsn;
			Count = count;
		}
