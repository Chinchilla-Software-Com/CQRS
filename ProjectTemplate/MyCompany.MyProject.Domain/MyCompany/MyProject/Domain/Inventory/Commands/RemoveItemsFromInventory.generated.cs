...
namespace MyCompany.MyProject.Domain.Inventory.Commands
{
	...
	public  partial class RemoveItemsFromInventoryCommand : ICommand<Cqrs.Authentication.ISingleSignOnToken>
	{
		...
		public RemoveItemsFromInventoryCommand(Guid rsn, long count)
		{
			Rsn = rsn;
			Count = count;
		}
